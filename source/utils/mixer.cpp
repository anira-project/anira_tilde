...
mixer::mixer() : m_sample_rate(0.0), m_buffer_size(0), m_latency_samples(0), m_mix(1.0f), m_write_index(0), m_read_index(0)
{

}

void mixer::prepare(double sample_rate, size_t buffer_size, size_t latency_samples) {
