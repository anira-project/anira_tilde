...
public:
    ...
    MIN_DESCRIPTION{
        ...
        "The anira~ external integrates the <a "
        "href='https://github.com/anira-project/anira'>anira</a> library to offer neural network "
        "inference inside Max. "
        "Inlets and outlets are dynamically configured during object initialization streamable "
        "(signal) and non-streamable (message) data. "
